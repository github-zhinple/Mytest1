...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\..\\..\\SiliconLabs\\SimplicityStudio\\v5\\developer\\sdks\\gecko_sdk_suite\\v3.1\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 1 --manuf-id 0x1002 --image-type 4098 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL ralay_test_proj"':
        sys.exit(0)
    print (" ")
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\..\\..\\SiliconLabs\\SimplicityStudio\\v5\\developer\\sdks\\gecko_sdk_suite\\v3.1\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 1 --manuf-id 0x1002 --image-type 4098 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL ralay_test_proj"'.replace("\t", "\\t")
