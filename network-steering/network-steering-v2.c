...
#else
      emberEventControlSetDelayMS(channel_scan_envent_control, 2000);
#endif
      return;
    }
  }
...
void channel_scan_envent_handler(void)
{
    emberEventControlSetInactive(channel_scan_envent_control);
    emAfPluginNetworkSteeringState = FIRST_SECONDARY_STATE;
    (void)scheduleScan(emAfPluginNetworkSteeringSecondaryChannelMask);
